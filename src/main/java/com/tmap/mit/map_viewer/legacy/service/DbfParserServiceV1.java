package com.tmap.mit.map_viewer.legacy.service;
...
@Slf4j
@Service
public class DbfParserServiceV1 {
    ...
    public DbfDto.ResData getDbfParserDataNoCache(String fileName) throws IOException {
        MappedByteBuffer headerBuffer = FileReadUtils.initializeBuffer(DbfFile.DBF_FILE_PATH_FORMAT, fileName+".dbf", ByteOrder.LITTLE_ENDIAN);
