...
public class FileRecordContent {
    ...
    public static final int IDX_POLYGON_MIN_X = 4;
    public static final int IDX_POLYGON_MIN_Y = 12;
    public static final int IDX_POLYGON_MAX_X = 20;
    public static final int IDX_POLYGON_MAX_Y = 28;
